...
public class RecyclerViewAdapterThursday extends RecyclerView.Adapter<RecyclerViewAdapterThursday.ViewHolder> {

    Context context;
    List<Mondaydetails>FiredbList;

    public RecyclerViewAdapterThursday(Context context, List<Mondaydetails> TempList) {
