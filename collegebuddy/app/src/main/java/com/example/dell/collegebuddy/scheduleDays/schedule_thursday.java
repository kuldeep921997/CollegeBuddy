...
public class schedule_thursday extends AppCompatActivity implements View.OnClickListener {
    ...
    RecyclerAdapterThursday mAdeptar;
    showThursdaySchedule showThursdaySchedule;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdeptar= new RecyclerAdapterThursday();
        showThursdaySchedule= new showThursdaySchedule();
    ...
    public void addData(){
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(taketime.equals("") )
                    Toast.makeText(schedule_thursday.this,"Starting Time Empty !",Toast.LENGTH_SHORT).show();
                else if(taketimeend.equals(""))
                    Toast.makeText(schedule_thursday.this,"Ending Time Empty !",Toast.LENGTH_SHORT).show();
                else if(subject.equals(""))
                    Toast.makeText(schedule_thursday.this,"Subject Name Empty !",Toast.LENGTH_SHORT).show();

                else {

                    mydb.insertDataThursday(subject, starting_time, end_time);
                    mAdeptar.notifyDataSetChanged();
                    mAdeptar.notifyItemRangeChanged(0,dbList.size());
                    int id=mydb.returnidnoThursday();
                    Log.d("findid","ID ="+" "+id);
                    mAdeptar.notifyItemInserted(id);
                    Toast.makeText(schedule_thursday.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                    //                  refreshpage();
                }
    ...
    public void onBackPressed()
    {
        Intent intent;
        super.onBackPressed();
        intent= new Intent(schedule_thursday.this,week_activity.class);
