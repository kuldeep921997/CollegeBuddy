...
public class RecyclerAdapterSaturday extends RecyclerView.Adapter<RecyclerAdapterSaturday.ViewHolder> {

    public static RecyclerView.Adapter mAdapter;
    static   List<DatabaseModelSaturday> dbList;
    static  Context context;
    static int selectedPos;
    showSaturdaySchedule showsaturday = new showSaturdaySchedule();
    public RecyclerAdapter.OnItemClickListner mListner;


    public RecyclerAdapterSaturday() {
    }
    ...
    public RecyclerAdapterSaturday(showSaturdaySchedule showSaturdaySchedule , List<DatabaseModelSaturday> dbList){
        this.dbList = new ArrayList<DatabaseModelSaturday>();
        this.dbList = dbList;
    }

    @Override
    public RecyclerAdapterSaturday.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.activity_day_sub_desc, null);
        ViewHolder viewHolderSaturday = new ViewHolder(itemLayoutView,mListner);
        return viewHolderSaturday;
    }

    @Override
    public void onBindViewHolder(final RecyclerAdapterSaturday.ViewHolder holder, int position) {
    ...
    public void getItemSelected(MenuItem item, Context context) {
        DatabaseModelSaturday p = dbList.get(selectedPos);
        ...
        switch (item.getItemId()) {
            ...
            case 0: {
                ...
                showsaturday.deletefunction(idhere);
            }
            break;
