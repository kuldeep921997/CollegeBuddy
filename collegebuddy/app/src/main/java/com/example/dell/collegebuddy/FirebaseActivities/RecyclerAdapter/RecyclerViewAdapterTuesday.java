...
public class RecyclerViewAdapterTuesday extends RecyclerView.Adapter<RecyclerViewAdapterTuesday.ViewHolder> {

    Context context;
    List<Mondaydetails>FiredbList;

    public RecyclerViewAdapterTuesday(Context context, List<Mondaydetails> TempList) {
