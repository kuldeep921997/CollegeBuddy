...
public class RecyclerViewAdapterSunday extends RecyclerView.Adapter<RecyclerViewAdapterSunday.ViewHolder> {

    Context context;
    List<Mondaydetails>FiredbList;

    public RecyclerViewAdapterSunday(Context context, List<Mondaydetails> TempList) {
