...
public class RecyclerViewAdapterSaturday extends RecyclerView.Adapter<RecyclerViewAdapterSaturday.ViewHolder> {

    Context context;
    List<Mondaydetails>FiredbList;

    public RecyclerViewAdapterSaturday(Context context, List<Mondaydetails> TempList) {
