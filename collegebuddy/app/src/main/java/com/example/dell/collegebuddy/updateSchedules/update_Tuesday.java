...
public class update_Tuesday extends AppCompatActivity implements View.OnClickListener {
    ...
    public void UpdateData(){
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                if(taketime.equals("") )
                                                    Toast.makeText(update_Tuesday.this,"Starting Time Empty !",Toast.LENGTH_SHORT).show();
                                                else if(taketimeend.equals(""))
                                                    Toast.makeText(update_Tuesday.this,"Ending Time Empty !",Toast.LENGTH_SHORT).show();
                                                else if(subject.equals(""))
                                                    Toast.makeText(update_Tuesday.this,"Subject Name Empty !",Toast.LENGTH_SHORT).show();


                                                else {
                                                    mydb.updateDataTuesday(idherenow,subject, starting_time, end_time);
                                                    mAdeptar.notifyDataSetChanged();
                                                    mAdeptar.notifyItemRangeChanged(0,dbList.size());
                                                    //mAdeptar.notifyItemInserted(id);
                                                    Toast.makeText(update_Tuesday.this, "Data Updated", Toast.LENGTH_SHORT).show();
                                                    Intent intent = new Intent(update_Tuesday.this,showTuesdaySchedule.class);
