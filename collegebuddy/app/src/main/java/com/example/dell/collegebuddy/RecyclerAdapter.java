...
import java.util.List;import com.example.dell.collegebuddy.Utils.LetterImageView;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    showMondaySchedule showmonday = new showMondaySchedule();
    ...
    public RecyclerAdapter(showMondaySchedule showMondaySchedule , List<DatabaseModel> dbList){
    ...
    public RecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewHolder viewHolder = new ViewHolder(itemLayoutView,mListner);
        return viewHolder;
    }
    ...
    public void getItemSelected(MenuItem item, Context context) {
        DatabaseModel p = dbList.get(selectedPos);
        ...
        switch (item.getItemId()) {
            ...
            case 0: {
                ...
                notifyDataSetChanged();
                showmonday.deletefunction(idhere);
            }
            break;

            case 1: {

                Intent intent = new Intent(context,update_Monday.class);
