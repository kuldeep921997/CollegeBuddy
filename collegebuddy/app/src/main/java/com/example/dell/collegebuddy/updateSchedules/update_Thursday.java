...
public class update_Thursday extends AppCompatActivity implements View.OnClickListener {
    ...
    public void UpdateData(){
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                if(taketime.equals("") )
                                                    Toast.makeText(update_Thursday.this,"Starting Time Empty !",Toast.LENGTH_SHORT).show();
                                                else if(taketimeend.equals(""))
                                                    Toast.makeText(update_Thursday.this,"Ending Time Empty !",Toast.LENGTH_SHORT).show();
                                                else if(subject.equals(""))
                                                    Toast.makeText(update_Thursday.this,"Subject Name Empty !",Toast.LENGTH_SHORT).show();


                                                else {
                                                    mydb.updateDataThursday(idherenow,subject, starting_time, end_time);
                                                    mAdeptar.notifyDataSetChanged();
                                                    mAdeptar.notifyItemRangeChanged(0,dbList.size());
                                                    //mAdeptar.notifyItemInserted(id);
                                                    Toast.makeText(update_Thursday.this, "Data Updated", Toast.LENGTH_SHORT).show();
                                                    Intent i = new Intent(update_Thursday.this,showThursdaySchedule.class);
                                                    startActivity(i);
                                                }
