...
public class schedule_sunday extends AppCompatActivity implements View.OnClickListener {
    ...
    public void addData(){
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(taketime.equals("") )
                    Toast.makeText(schedule_sunday.this,"Starting Time Empty !",Toast.LENGTH_SHORT).show();
                else if(taketimeend.equals(""))
                    Toast.makeText(schedule_sunday.this,"Ending Time Empty !",Toast.LENGTH_SHORT).show();
                else if(subject.equals(""))
                    Toast.makeText(schedule_sunday.this,"Subject Name Empty !",Toast.LENGTH_SHORT).show();

                else {

                    mydb.insertDataSunday(subject, starting_time, end_time);
                    mAdeptar.notifyDataSetChanged();
                    mAdeptar.notifyItemRangeChanged(0,dbList.size());
                    int id=mydb.returnidnoSunday();
                    Log.d("findid","ID ="+" "+id);
                    mAdeptar.notifyItemInserted(id);
                    Toast.makeText(schedule_sunday.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                    //                  refreshpage();
                }
    ...
    public void onBackPressed()
    {
        Intent intent;
        super.onBackPressed();
        intent= new Intent(schedule_sunday.this,week_activity.class);
